...
public enum Language implements Cloneable, Serializable {
    ...
    BIHARI_LANGUAGES("bih","bh","Bihari languages"),
    BISLAMA("bis","bi","Bislama"),
    BOSNIAN("bos","bs","Bosnian"),
    BRETON("bre","br","Breton"),
    BULGARIAN("bul","bg","Bulgarian"),
    CATALAN("cat","ca","Catalan; Valencian"),
    CHAMORRO("cha","ch","Chamorro"),
    CHECHEN("che","ce","Chechen"),
    CHURCH_SLAVIC("chu","cu","Church Slavic; Old Slavonic; Church Slavonic; Old Bulgarian; Old Church Slavonic"),
    ...
    DIVEHI("div","dv","Divehi; Dhivehi; Maldivian"),
    ...
    GAELIC("gla","gd","Gaelic; Scottish Gaelic"),
    IRISH("gle","ga","Irish"),
    GALICIAN("glg","gl","Galician"),
    MANX("glv","gv","Manx"),
    GUARANI("grn","gn","Guarani"),
    GUJARATI("guj","gu","Gujarati"),
    HAITIAN("hat","ht","Haitian; Haitian Creole"),
    HAUSA("hau","ha","Hausa"),
    ...
    IGBO("ibo","ig","Igbo"),
    IDO("ido","io","Ido"),
    SICHUAN_YI("iii","ii","Sichuan Yi; Nuosu"),
    INUKTITUT("iku","iu","Inuktitut"),
    INTERLINGUE("ile","ie","Interlingue; Occidental"),
    INTERLINGUA ("ina","ia","Interlingua (International Auxiliary Language Association)"),
    ...
    KALAALLISUT("kal","kl","Kalaallisut; Greenlandic"),
    KANNADA("kan","kn","Kannada"),
    KASHMIRI("kas","ks","Kashmiri"),
    KANURI("kau","kr","Kanuri"),
    KAZAKH("kaz","kk","Kazakh"),
    CENTRAL_KHMER("khm","km","Central Khmer"),
    KIKUYU("kik","ki","Kikuyu; Gikuyu"),
    KINYARWANDA("kin","rw","Kinyarwanda"),
    KIRGHIZ("kir","ky","Kirghiz; Kyrgyz"),
    KOMI("kom","kv","Komi"),
    KONGO("kon","kg","Kongo"),
    KOREAN("kor","ko","Korean"),
    KUANYAMA("kua","kj","Kuanyama; Kwanyama"),
    KURDISH("kur","ku","Kurdish"),
    LAO("lao","lo","Lao"),
    LATIN("lat","la","Latin"),
    LATVIAN("lav","lv","Latvian"),
    LIMBURGAN("lim","li","Limburgan; Limburger; Limburgish"),
    LINGALA("lin","ln","Lingala"),
    LITHUANIAN("lit","lt","Lithuanian"),
    LUXEMBOURGISH("ltz","lb","Luxembourgish; Letzeburgesch"),
    ...
    NAURU("nau","na","Nauru"),
    NAVAJO("nav","nv","Navajo; Navaho"),
    NDONGA("ndo","ng","Ndonga"),
    NEPALI("nep","ne","Nepali"),
    DUTCH("nld","nl","Dutch; Flemish"),
    NORWEGIAN("nor","no","Norwegian"),
    CHICHEWA("nya","ny","Chichewa; Chewa; Nyanja"),
    OCCITAN ("oci","oc","Occitan (post 1500)"),
    OJIBWA("oji","oj","Ojibwa"),
    ORIYA("ori","or","Oriya"),
    OROMO("orm","om","Oromo"),
    OSSETIAN("oss","os","Ossetian; Ossetic"),
    PANJABI("pan","pa","Panjabi; Punjabi"),
    PERSIAN("fas","fa","Persian"),
    PALI("pli","pi","Pali"),
    POLISH("pol","pl","Polish"),
    PORTUGUESE("por","pt","Portuguese"),
    PUSHTO("pus","ps","Pushto; Pashto"),
    QUECHUA("que","qu","Quechua"),
    ROMANSH("roh","rm","Romansh"),
    ROMANIAN("ron","ro","Romanian; Moldavian; Moldovan"),
    RUNDI("run","rn","Rundi"),
    RUSSIAN("rus","ru","Russian"),
    SANGO("sag","sg","Sango"),
    SANSKRIT("san","sa","Sanskrit"),
    SINHALA("sin","si","Sinhala; Sinhalese"),
    ...
    SPANISH("spa","es","Spanish; Castilian"),
