...
public final class LexicalResourceFactory {
    ...
    public static LexicalResource getLexicalResource(Class<? extends LexicalResource> resourceType, OntologyModel model, Locale language) throws IllegalAccessException, InvocationTargetException, InstantiationException, NoSuchMethodException, ClassNotFoundException {
