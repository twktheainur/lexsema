 ...
 */
public final class LexicalSenseBabelNetPropertiesQueryProcessor extends AbstractQueryProcessor<Map<String, String>> {
    ...
    public LexicalSenseBabelNetPropertiesQueryProcessor(Graph graph,
                                                        String uri) {
        super(graph);
        this.uri = uri;
        initialize();
