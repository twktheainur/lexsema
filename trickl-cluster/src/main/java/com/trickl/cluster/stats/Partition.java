    ...
    public static double xieBeniIndex(DoubleMatrix2D U, DoubleMatrix2D V, DoubleMatrix2D X, double m) {
        ...
        for (int k = 0; k < clusters; k++) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                dev_i.assign(X.viewRow(i), DoubleFunctions.minus);
        ...
        for (int k = 0; k < clusters; k++) {
            for (int k2 = 0; k2 < clusters; k2++) {
                ...
                if (k != k2) {
                    ...
                    dev_k.assign(X.viewRow(k2), DoubleFunctions.minus);

                    // Calculate magnitude of dev_k
                    double separation = dev_k.aggregate(DoubleFunctions.plus, DoubleFunctions.square);
        ...
        for (int i = 0; i < I.columns(); ++i) {
            for (int j = 0; j < I.rows(); ++j) {
                if (i == j) {
                    ...
                    umin.assign(U.viewColumn(j), DoubleFunctions.min);
