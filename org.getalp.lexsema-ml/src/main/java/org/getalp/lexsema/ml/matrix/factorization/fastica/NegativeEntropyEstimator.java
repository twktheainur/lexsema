...
package org.getalp.lexsema.ml.matrix.factorization.fastica;
...
public interface NegativeEntropyEstimator {
     ...
     * the results.
     *
     * @param x {@link cern.colt.matrix.tdouble.DoubleMatrix2D} containing column vectors of data
     *          to transform
     */
    abstract void estimate(DoubleMatrix2D x);

    /**
     * @return {@link cern.colt.matrix.tdouble.DoubleMatrix2D} 	containing the value of the G function
     * applied to each value of the input matrix
     */
    abstract DoubleMatrix2D getGx();

    /**
     * @return {@link cern.colt.matrix.tdouble.DoubleMatrix2D} 	containing the value of the average of
     * the first derivative of the G function applied to each
     * value of the input matrix
     */
    abstract DoubleMatrix1D getG_x();
