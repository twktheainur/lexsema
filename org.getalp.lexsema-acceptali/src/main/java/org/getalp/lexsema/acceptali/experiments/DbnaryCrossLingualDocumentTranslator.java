...
public final class DbnaryCrossLingualDocumentTranslator implements Translator{
    ...
    private static Logger logger = LoggerFactory.getLogger(DbnaryCrossLingualDocumentTranslator.class);
    ...
    private DbnaryCrossLingualDocumentTranslator(DBNary dbNary) {
        this.dbNary = dbNary;
    }
