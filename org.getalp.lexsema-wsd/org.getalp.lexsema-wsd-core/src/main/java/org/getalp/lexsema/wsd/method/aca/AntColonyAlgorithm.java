...
public class AntColonyAlgorithm implements Disambiguator {
    ...
    public AntColonyAlgorithm(SimilarityMeasure similarityMeasure, int maxIterations, int initialEnergy, int initialPheromone, int vectorSize, double pheromoneEvaporation, double maximumEnergy, double antLife, double depositPheromone, double takeEnergy, double componentsDeposited) {
        ...
        environmentUpdater = new SchwabEtAl2012EnvironmentUpdater(initialEnergy,maximumEnergy,antLife, antFactory, antUpdater, mersenneTwister);
    }
