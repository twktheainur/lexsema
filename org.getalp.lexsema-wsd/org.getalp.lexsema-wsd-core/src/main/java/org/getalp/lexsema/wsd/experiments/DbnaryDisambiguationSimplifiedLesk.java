...
public class DbnaryDisambiguationSimplifiedLesk {
    ...
    public static void main(String[] args) throws NoSuchMethodException, IOException, InstantiationException, IllegalAccessException, InvocationTargetException, ClassNotFoundException {
        ...
        CorpusLoader dl = new Semeval2013Task12CorpusLoader("../data/semeval-2013-task12-test-data/data/multilingual-all-words.en.xml")
        ...
        for (Document d : dl) {
            LRLoader lrloader = new DBNaryLoaderImpl(DB_PATH, ONTOLOGY_PROPERTIES, d.getLanguage()).shuffle(true);
