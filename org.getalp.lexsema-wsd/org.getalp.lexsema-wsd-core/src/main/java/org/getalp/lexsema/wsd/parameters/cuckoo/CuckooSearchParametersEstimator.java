...
import org.getalp.lexsema.wsd.method.cuckoo.generic.CuckooSearchOneNest;
...
public class CuckooSearchParametersEstimator
{
    public static void main(String[] args) throws Exception
    {
        ...
        CuckooSearch cuckoo = new CuckooSearch(iterations, levyScale, nestsNumber, destroyedNests, scorer, configFactory, true);
